...
for i in df['location']:
    # UserIdsforNewYorkerMatrix.append(df.loc[ix,'UserID'])
    if i != 'None':
        ...
        for k in strippedgazetteer:
            if k in j:
                ...
                # newYorkerYesNoforMatrix.append(1)
                continue
            # else:
