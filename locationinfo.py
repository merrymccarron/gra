# numberOfNewYorkers:110,974
# numberOfUsersLocations:859,868
# dataframe size: (1,512,903 rows, 5 columns)
# 172-16-18-19
...
df = pd.DataFrame(data={'UserID':[], 'location': [],'screen_name': [], 'name':[], 'geo_enabled': []})

for csvfile in glob.glob('sociallandmarks/*details.csv'):
	tempdf = pd.read_csv(csvfile, index_col=0).fillna(value=0)
	df = df.append(tempdf)
